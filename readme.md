...
## 프로젝트 설명
### 생산계획서 작성업무를 맡은 윤제욱 사원...
![설명](data/img/image3.png)
**위와 같은 업무가 주어졌을 때 어떤 기준으로 생산계획을 수립하면 좋을까?**
1. "하루에 100개씩 1~5번품목 생산하죠!" 라고 한뒤 생산계획서를 작성한다.
2. "최소한의 비용으로 생산하겠습니다!" 라고 한뒤 비용최적화 모델을 생성, 생산계획서를 수립한다.   

### 나의 선택 : 2번, 비용 최적화 프로젝트를 진행
- 아래와 같이 품목별, 일자별 생산계획서를 작성하여, 설비의 전류 소모량을 감축할 수 있다!
![최적화](data/img/image4.png)
![최적화](data/img/image11.png)
